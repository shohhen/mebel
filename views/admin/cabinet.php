...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <span class="d-none d-md-block dropdown-toggle ps-2">Hello, <?=$_SESSION['user']['data']['username']?></span>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1><?=$_SESSION['user']['data']['username']?></h1>
      <nav>
        <ol class="breadcrumb">
                ...
                <div class="card-body pb-0">
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/images/<?=$projectList['img']?>" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold"><?=$projectList['name']?></a></td>
                        <td><?=$projectList['catname']?></td>
                        <td><?=$projectList['desciption']?></td>
                        <td><a href="/cabinet/delete/<?=$projectList['id']?>" class="btn btn-danger">Delete</a></td>
